    ...
    <ul class="nav">
        ...
        <div class="profile-desc">
          <div class="profile-pic">
            ...
            <div class="profile-name">
              <h5 class="mb-0 font-weight-normal">Faisal Awan</h5>
              <span>Admin</span>
            </div>
          </div>
      ...
      <li class="nav-item menu-items">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{url('product_view')}}">Add Products</a></li>
            <li class="nav-item"> <a class="nav-link" href="{{url('show_product')}}">Show Products</a></li>
            {{-- <li class="nav-item"> <a class="nav-link" href="{{url('update_product_view')}}">Update Products</a></li> --}}
